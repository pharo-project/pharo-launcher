# How to get the pharo launcher in command line ? 
You can download the pharo launcher in command line right [here](https://ci.inria.fr/pharo-ci-jenkins2/job/PharoLauncherCmdLine-Pipeline/job/merge-david-axel/). 
...
Options:
-h, --help ,               Prints help about this command.
--script ,     			   Launch the image with the selected script ( need the script path)
```
Example of use:  
```
...
If you want more informations don't hesitate to check our github page: [https://github.com/PharoLauncherCmdLine/CommandLineLauncher](https://github.com/PharoLauncherCmdLine/CommandLineLauncher) 
If you have problems you can add an issue on the same github. 